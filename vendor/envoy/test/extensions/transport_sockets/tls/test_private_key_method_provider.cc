...
static void dummy(const char *file, int line) {
  fprintf(stderr, "%s:%d : ***************************************************************\n", file, line);
}
...
// 
void TestPrivateKeyMethodProvider::registerPrivateKeyMethod(SSL*, Ssl::PrivateKeyConnectionCallbacks&, Event::Dispatcher&) {
  dummy(__FILE__, __LINE__);
}
...
// }
// 
void TestPrivateKeyMethodProvider::unregisterPrivateKeyMethod(SSL*) {
}
