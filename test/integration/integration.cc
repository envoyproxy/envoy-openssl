...
void BaseIntegrationTest::createGeneratedApiTestServer(const std::string& bootstrap_path,
  ...
  test_server_ = IntegrationTestServer::create(
      bootstrap_path, version_, on_server_ready_function_, on_server_init_function_, deterministic_, timeSystem(), *api_,
...
BaseIntegrationTest::createIntegrationTestServer(const std::string& bootstrap_path,
  ...
  return IntegrationTestServer::create(bootstrap_path, version_, on_server_ready_function, on_server_init_function,
